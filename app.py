...
movie_list = pickle.load(open('E:\Projects\Movie-Recommendation-System\movie_list.pkl','rb'))
similarity = pickle.load(open('E:\Projects\Movie-Recommendation-System\similarity.pkl','rb'))
